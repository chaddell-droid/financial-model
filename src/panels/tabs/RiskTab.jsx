  ...
  return (
    <>
      ...
      >
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 8 }}>
          <div style={{ fontSize: 12, color: '#cbd5e1', lineHeight: 1.45 }}>
            1. Monte Carlo answers how often the six-year plan stays above zero and how bad the typical downside gets.
          </div>
          <div style={{ fontSize: 12, color: '#cbd5e1', lineHeight: 1.45 }}>
      ...
      <RiskQuestion
        ...
        step="Question 1"
        title="How often does the plan stay solvent over the 6-year outlook?"
